...
export {}
declare global {
  const ETF_LINKS: typeof import('../../utils/constants').ETF_LINKS
  const FUND_MAPPING: typeof import('../../utils/constants').FUND_MAPPING
  const MOCK_FUNDS: typeof import('../../utils/constants').MOCK_FUNDS
  const PERSONAS: typeof import('../../utils/constants').PERSONAS
  const QUESTIONS: typeof import('../../utils/constants').QUESTIONS
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly ETF_LINKS: UnwrapRef<typeof import('../../utils/constants')['ETF_LINKS']>
    readonly FUND_MAPPING: UnwrapRef<typeof import('../../utils/constants')['FUND_MAPPING']>
    readonly MOCK_FUNDS: UnwrapRef<typeof import('../../utils/constants')['MOCK_FUNDS']>
    readonly PERSONAS: UnwrapRef<typeof import('../../utils/constants')['PERSONAS']>
    readonly QUESTIONS: UnwrapRef<typeof import('../../utils/constants')['QUESTIONS']>
